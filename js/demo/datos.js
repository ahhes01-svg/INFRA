 ...
 *
 * Contexto peruano real (Ica, Pisco, Chincha, Nazca). Se descarga únicamente
 * cuando la aplicación arranca sin backend, para poder enseñarla sin conexión.
 * Rellena el almacén declarado en js/core/calc.js y aporta las mutaciones en
 * memoria equivalentes a las funciones del servidor.
 * ==========================================================================*/

const { D, ahora, tocar } = window.__nucleo;
